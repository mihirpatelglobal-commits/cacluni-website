...
const customContent = {
  ...
  'concrete-calculator': {
    ...
    faqs: [
      { q: 'Why is it recommended to add a 10% wastage margin for concrete?', a: 'Wastage is critical because slabs are rarely perfectly uniform, ground settling occurs, and some concrete always sticks to the mixer or is spilled during pouring. A 10% wastage buffer prevents running out of materials mid-job.' },
  ...
  'paint-calculator': {
    ...
    faqs: [
      { q: 'How much area does one standard gallon of paint cover?', a: 'A standard gallon of quality wall paint typically covers approximately 350 to 400 square feet of smooth, primed wall surface with a single coat. Rough or textured walls require more paint.' },
      { q: 'Why do I need to apply two coats of paint?', a: 'Two coats of paint ensure a uniform color depth, cover patches or primer, prevent streaks, and create a more durable surface that resists wear, scrubbing, and color fading over time.' },
      { q: 'Should I buy primer separately?', a: 'Yes, if you are painting raw drywall, making a drastic color change (dark to light), or painting over glossy surfaces. Primer seals the substrate, improves adhesion, and reduces the number of paint coats needed.' },
      { q: 'How do I calculate paint requirements for ceilings?', a: 'To calculate paint for ceilings, find the floor square footage of the room (Length * Width). Divide this area by 350 to find the gallons needed per ceiling coat.' },
      { q: 'What is the shelf life of unused paint?', a: 'Properly sealed latex paint can last up to 10 years in a cool, dry place. Ensure the rim is clean, seal the lid tightly, and store it away from freezing temperatures.' }
    ]
  },
  'tile-calculator': {
    ...
    faqs: [
      { q: 'How much extra tile should I buy for waste?', a: 'It is standard practice to buy 10% extra tile for standard straight layouts, and 15% extra for diagonal or herringbone patterns. This covers tile cuts, border trimming, and accidental breakage.' },
      { q: 'Does grout spacing affect the number of tiles I need?', a: 'For standard tiles (12x12 inches or larger), grout spacing has a negligible effect on the total tile count. For small mosaic tiles, wide grout joints can slightly reduce the total tiles needed.' },
      { q: 'How do I calculate tile coverage for an irregular room?', a: 'Divide the floor space into smaller rectangular sections, calculate the square footage of each, and sum them. Always add a 15% waste factor for irregular layouts to cover complex cuts.' },
      { q: 'Should I round up the number of tiles?', a: 'Yes. Always round up to the nearest whole tile when calculating individual tile counts, and round up to the nearest full box when ordering from a supplier to ensure you have complete packages.' },
      { q: 'How many tiles are typically in a box?', a: 'The number of tiles in a box depends on the tile size and manufacturer. Standard 12x12 tiles often come in boxes of 10 to 15 pieces, covering 10 to 15 square feet.' }
    ]
  },
  'roofing-calculator': {
